      ...
      >
        <div className="flex flex-row items-center">
          ...
          <div className="mx-1 flex flex-shrink flex-grow-0 flex-row items-center truncate text-zinc-400 line-through">
            ...
            <span className="text-sm font-light">186.100</span>
          </div>
          <div className="rounded-sm bg-theme-1-primary-50 px-1 py-0.5 text-2xs font-semibold">
            <span className="text-theme-1-primary-600">-52%</span>
          </div>
          <div className="rounded-sm bg-theme-1-primary-50 px-1 py-0.5 text-2xs font-semibold">
            <span className="text-theme-1-primary-600">Hemat 96.800</span>
          </div>
        </div>
        <div>
